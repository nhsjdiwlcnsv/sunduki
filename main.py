...
def main():
    ...
    model.compile()
    model.load_weights('weights/adam-v3.6/adam-v3.6.ckpt')
    model.train('MineRLTreechop-v0', 'weights/adam-v3.6/adam-v3.6.ckpt')
    # agent = Agent(model, obs, monitor)

    # Load the weights from the given path and gather some wood acting in the overground mode
    # agent.load_brain("weights/adam-v3.6/adam-v3.6.ckpt")
    ...
    # agent.load_brain("weights/adam-v3.6.0/adam-v3.6.0.ckpt")
